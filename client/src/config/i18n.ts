...
import studyResultItemVi from '../locales/vi/studyResultItem';
...
import studyResultItemEn from '../locales/en/studyResultItem'
    ...
    .init({
        ...
        resources: {
            vi: {
                ...
                studyResultItem: studyResultItemVi,
                common: commonVi,
            },
            en: {
                student: studentEn,
                ...
                studyResultItem: studyResultItemEn,
                common: commonEn
            },
        },
        interpolation: {
